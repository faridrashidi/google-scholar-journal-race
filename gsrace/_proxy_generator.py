...
class ProxyGenerator:
    ...
    def Luminati(self, usr, passwd, proxy_port):
        ...
        if usr is not None and passwd is not None and proxy_port is not None:
            ...
            self.logger.warning(
                "Not enough parameters were provided for the Luminati proxy. Reverting"
    ...
    def Tor_Internal(self, tor_cmd=None, tor_sock_port=None, tor_control_port=None):
        ...
        if tor_cmd is None:
            self.logger.info(
                "No tor_cmd argument passed. This should point to the location of Tor"
                " executable."
            )
            return {
                "proxy_works": False,
    ...
    def _handle_captcha2(self, url):
        ...
        while cur < timeout:
            try:
                ...
                self.logger.info(
                    f"Solving the captcha took already {cur} seconds (of maximum"
                    f" {timeout} s)."
                )
