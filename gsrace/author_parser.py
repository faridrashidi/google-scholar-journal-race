...
_COAUTH = (
    "https://scholar.google.com/citations?user={0}&hl=en"
...
class AuthorParser:
    ...
    def _get_coauthors_long(self, author):
        ...
        with self.nav.pm2._get_webdriver() as wd:
            ...
            coauthor_ids = [
                re.findall(_CITATIONAUTHRE, coauth.get_attribute("href"))[0]
                for coauth in coauthors
            ]
            coauthor_names = [
                name.text for name in wd.find_elements(By.CLASS_NAME, "gs_ai_name")
            ]
            coauthor_affils = [
                affil.text for affil in wd.find_elements(By.CLASS_NAME, "gs_ai_aff")
            ]
